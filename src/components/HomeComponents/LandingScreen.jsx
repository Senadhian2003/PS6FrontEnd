...
function LandingScreen() {
  return (
    <div className="flex-1 flex flex-col justify-center text-justify">
      <div className="flex flex-col-reverse md:flex-row space-x-16 justify-between ">
        <div className=" max-w-[540px] flex flex-col  justify-center">
          <h1 className='my-4 text-lg font-normal relative after:content-[""] after:block after:w-3/12 after:pt-[3px] after:border-b-2 after:border-white'>
            The Future of Gaming Is Here
          </h1>
          <p className="title font-bayon my-4 ">
          ...
          <div className="flex justify-between items-center mt-8">
            ...
            />
            <ActionButton
              content={"WATCH THE REVEAL"}
              iconLight={GlassesIcon}
              iconDark={DarkGlassesIcon}
            />
          </div>
        </div>
